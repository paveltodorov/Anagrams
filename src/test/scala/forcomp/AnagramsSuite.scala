...
class AnagramsSuite {
  ...
  @Test def `sentenceOccurrences: abcd d (5pts)`: Unit =
    assertEquals(List(('a', 1), ('b', 1), ('c', 1), ('d', 2)), sentenceOccurrences(List("abcd", "d")))

  @Test def `sentenceOccurrences: abcd b abe (5pts)`: Unit =
    assertEquals(List(('a', 2), ('b', 3), ('c', 1), ('d', 1), ('e', 1)), sentenceOccurrences(List("abcd", "b","abe")))
  ...
  @Test def `subtract: larrrd - r (10pts)`: Unit = {
  ...
  @Test def `subtract: abc - abd (10pts)`: Unit = {
    val lard = List(('a', 1), ('b', 1), ('c', 1))
    val r = List(('a', 1), ('b', 1), ('d', 1))
    val lad = List(('c', 1))
    assertEquals(lad, subtract(lard, r))
  }
